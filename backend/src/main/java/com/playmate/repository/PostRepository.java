...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    Page<Post> findByGameName(@Param("status") PostStatus status, @Param("gameName") String gameName, Pageable pageable);
    ...
    Page<Post> findByUserIdsAndKeyword(@Param("status") PostStatus status, @Param("userIds") List<Long> userIds, @Param("keyword") String keyword, Pageable pageable);
    ...
    List<Post> findRecentPostsByUserId(@Param("userId") Long userId, @Param("status") PostStatus status, Pageable pageable);
}